...
public class Person {
    ...
    void show() {
        // 每当打印成员变量的数值是，让年龄增长一岁
        grow();
        System.out.println("我是" + this.name + ",今年" + age + "岁了");
    }
    ...
    public static void main(String[] args) {
        ...
        // 当类中没有提供构造方法是，则下面调用默认构造方法，若勒种提供构造方法后，则下面调用类中提供的版本
        Person p1 = new Person("张飞", 30);
        // 并打印特征
        p1.show(); // null 10  张飞 30
